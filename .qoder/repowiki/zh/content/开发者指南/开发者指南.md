...
## 更新摘要
**变更内容**
- 更新项目元数据配置，包括项目名称从 wenyanwen 更改为 wyw，版本从 0.1.4 升级到 0.1.5
- 新增文档增强内容，包括详细的语法指南和写作技能文档
- 更新 CLI 命令和版本信息以反映项目名称变更
- 增强文档结构，提供更完整的开发者指导
...
**更新** 项目现已更名为 wyw（原名为 wenyanwen），版本升级至 0.1.5，并新增了完整的文档增强内容，包括详细的语法指南和写作技能文档。
...
- test：单元测试与集成测试
- examples：示例 .wyw 文件
- docs：文档与图片，包含详细的语法指南
- skill/wyw-writer：写作指南与示例，提供完整的文言文标记语言编写技能
...
subgraph "文档增强"
SYNTAX["docs/syntax-guide.md"]
SKILL["skill/wyw-writer/SKILL.md"]
end
BIN --> CLI
CLI --> SRC_INDEX
SRC_INDEX --> BLOCK
...
- 静态资源与交互
  ...
  - heti.css：排版基础样式
- 文档增强系统
  - 语法指南：详细的 .wyw 标记语言语法说明
  - 写作技能：完整的文言文标记语言编写与校验技能文档

**更新** 项目现已更名为 wyw，CLI 命令和版本信息已相应更新，同时新增了完整的文档增强系统。
...
### 文档增强系统
- 语法指南
  - 详细的 .wyw 标记语言语法说明，包含文件结构、块级语法、内联语法、完整示例和语法速查表
  - 提供丰富的示例和注意事项，帮助开发者理解各种标记语法的使用方法
- 写作技能
  - 完整的文言文标记语言编写与校验技能文档
  - 包含写作工作流、常见错误避免、验证清单等实用指导
  - 提供从入门到精通的学习路径和最佳实践

**更新** 新增的文档增强系统显著提升了项目的可用性和学习体验，为开发者提供了更全面的指导和支持。
...
- 文档相关问题
  - 语法指南不完整：参考 docs/syntax-guide.md 获取最新语法说明
  - 写作技能缺失：使用 skill/wyw-writer/SKILL.md 获取编写指导

**更新** 新增了文档相关的故障排查指导，帮助开发者更好地理解和使用项目的文档增强功能。
...
**更新** 随着项目更名为 wyw 并升级到 0.1.5，以及新增的文档增强内容，开发者现在拥有更完善的工具和指导来参与项目开发。
...
**更新** CLI 命令现已支持新的项目名称 wyw，版本信息也已更新为 0.1.5。
...
**更新** 项目现已更名为 wyw，版本升级至 0.1.5，开发者指南也相应更新以反映这些变更。
...
### 文档增强内容使用指南
- 语法指南使用
  - 参考 docs/syntax-guide.md 获取完整的 .wyw 标记语言语法说明
  - 使用语法速查表快速查找特定标记的使用方法
  - 阅读完整示例了解实际应用场景
- 写作技能应用
  - 使用 skill/wyw-writer/SKILL.md 获取编写工作流指导
  - 按照验证清单检查文档质量
  - 参考常见错误避免列表提升写作质量

**更新** 新增的文档增强内容为开发者提供了更全面的学习和参考资料。
